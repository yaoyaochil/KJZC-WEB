<template>
  <el-container class="layout-cont">
    <el-container :class="[isSider?'openside':'hideside',isMobile ? 'mobile': '']">
      ...
      <el-aside class="main-cont main-left bodo-aside">
        <div class="tilte" :style="{background: backgroundColor}">
          <img alt class="logoimg" :src="$BODO_ADMIN.appLogo">
          <div v-if="isSider" class="tit-text" :style="{color:textColor}">{{ $BODO_ADMIN.appName }}</div>
        </div>
        <Aside class="aside" />
      </el-aside>
      <!-- 分块滑动功能 -->
                  ...
                  <el-row class="pd-0">
                    <el-col :xs="2" :lg="1" :md="1" :sm="1" :xl="1" style="z-index:100">
                      <div class="menu-total" @click="totalCollapse">
                        <div v-if="isCollapse" class="bodoIcon bodoIcon-arrow-double-right" />
                        <div v-else class="bodoIcon bodoIcon-arrow-double-left" />
                      </div>
                    </el-col>

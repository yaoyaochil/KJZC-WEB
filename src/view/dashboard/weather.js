...
const amapKey = '94b798280af681d7064d07ea90640cdc'
...
const getWeather = async(code) => {
  ...
  if (response.data.status === '1') {
    ...
    weatherInfo.value = '☁️ ' + s.city + ' 天气：' + s.weather + ' 温度：' + s.temperature + ' 摄氏度 风向：' + s.winddirection + ' 风力：' + s.windpower + '级 空气湿度：' + s.humidity
  }
}
